    ...
    public int getRemoteIcon(int type) {
        switch (type) {
            case RemoteItem.SAFW:
                return R.drawable.ic_rclone_tablet_cellphone;
            case RemoteItem.AMAZON_DRIVE:
                return R.drawable.ic_rclone_amazon;
            case RemoteItem.AZUREBLOB:
                return R.drawable.ic_rclone_azure_storage_blob_logo;
            case RemoteItem.B2:
                return R.drawable.ic_rclone_backblaze_b2_black;
            case RemoteItem.GOOGLE_DRIVE:
                return R.drawable.ic_rclone_google_drive;
            case RemoteItem.DROPBOX:
                return R.drawable.ic_rclone_dropbox;
            case RemoteItem.GOOGLE_CLOUD_STORAGE:
                return R.drawable.ic_rclone_google;
            case RemoteItem.GOOGLE_PHOTOS:
                return R.drawable.ic_rclone_google_photos;
            case RemoteItem.KOOFR:
                return R.drawable.ic_rclone_koofr;
            case RemoteItem.MEGA:
                return R.drawable.ic_rclone_mega_logo_black;
            case RemoteItem.ONEDRIVE:
                return R.drawable.ic_rclone_onedrive;
            case RemoteItem.OPENDRIVE:
                return R.drawable.ic_rclone_open_drive;
            case RemoteItem.S3:
                return R.drawable.ic_rclone_amazon;
            case RemoteItem.BOX:
                return R.drawable.ic_rclone_box;
            case RemoteItem.SFTP:
                return R.drawable.ic_rclone_terminal;
            case RemoteItem.LOCAL:
                return R.drawable.ic_rclone_tablet_cellphone;
            case RemoteItem.PCLOUD:
                return R.drawable.ic_rclone_pcloud;
            case RemoteItem.UNION:
                return R.drawable.ic_rclone_union_24dp;
            case RemoteItem.WEBDAV:
                return R.drawable.ic_rclone_webdav;
            case RemoteItem.YANDEX:
                return R.drawable.ic_rclone_yandex_mono;
            default:
                return R.drawable.ic_rclone_cloud;
        }
    }
